# Historia ya Tanzania na Maadili — ADT Bundle Reference
...
**Historia ya Tanzania na Maadili** — Huu unaonekana kuwa ni kitabu cha shule kiitwacho Historia ya Tanzania na Maadili, kinacholenga kufundisha historia ya Tanzania pamoja na malezi ya maadili na uraia. Kutokana na alama ya “V”, kinaelekea kulengwa wanafunzi wa shule ya msingi takribani darasa la tano, kwa lugha ya Kiswahili cha Tanzania. Asili yake ni Tanzania, na kwa mtazamo wa ufundishaji, huenda kinachanganya maarifa ya kitaifa, utambulisho wa nchi, na mafunzo ya tabia njema kwa wanafunzi.
...
```
Historia-ya-Tanzania-na-Maadili-DRS-V/
├── adt/                              # THE WEB APP
...
├── Historia-ya-Tanzania-na-Maadili-DRS-V.db                    # SQLite database (pipeline state)
├── Historia-ya-Tanzania-na-Maadili-DRS-V.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Cheti cha ithibati cha Jamhuri ya Muungano wa Tanzania, Wizara ya Elimu, Sayansi na Teknolojia, kinachoidhinisha kitabu cha Historia ya Tanzania na Maadili cha mwanafunzi wa Darasa la Tano; kimechapishwa na Taasisi ya Elimu Tanzania, kina ISBN 978-9912-765-04-7, tarehe 31 Mei 2025, na saini ya Kamishna wa Elimu Dkt. Lyabwene M. Mtabwa.",
  "gl001": "ajira ya shuruti",
  "gl001_def": "kazi ya kulazimishwa bila hiari ya mtu."
}
```
...
{
  "ajira ya shuruti": {
    "word": "ajira ya shuruti",
    "definition": "kazi ya kulazimishwa bila hiari ya mtu.",
    "variations": ["ajira ya shuruti","kazi ya shuruti","shuruti"],
    "emoji": "⛏️🔒"
  }
}
```
...
```json
{
  "title": "Historia ya Tanzania na Maadili",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "sw-TZ"
...
| Original PDF | `Historia-ya-Tanzania-na-Maadili-DRS-V.pdf` |
| Pipeline database | `Historia-ya-Tanzania-na-Maadili-DRS-V.db` (SQLite) |
