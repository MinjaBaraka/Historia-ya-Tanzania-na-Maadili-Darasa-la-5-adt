...
**Historia ya Tanzania na Maadili** — Hiki ni kitabu cha Historia ya Tanzania na Maadili kinachoonekana kulengwa kwa wanafunzi wa shule ya msingi, hasa darasa la tano, kwa kuzingatia jina la faili “DRS V.” Kutokana na kichwa chake, kinahusu historia ya Tanzania pamoja na maadili na uraia, na kinaonekana kutoka Tanzania; pia kimeandikwa kwa Kiswahili. Ingawa maandishi yaliyotolewa yana taarifa chache sana za ndani, kitabu hiki kwa ujumla kinaonekana kufundisha maarifa ya msingi ya kijamii kwa mtazamo wa kitaaluma na wa malezi ya tabia njema.
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Cheti cha ithibati cha Wizara ya Elimu, Sayansi na Teknolojia cha kuidhinisha kitabu cha Historia ya Tanzania na Maadili, Kitabu cha Mwanafunzi Darasa la Tano, kilichochapishwa na Taasisi ya Elimu Tanzania, na kutiwa saini na Kamishna wa Elimu.",
  "gl001": "ajali",
  "gl001_def": "tukio baya lisilotarajiwa linaloweza kusababisha maumivu, uharibifu au kifo."
}
```
...
```json
{
  "ajali": {
    "word": "ajali",
    "definition": "tukio baya lisilotarajiwa linaloweza kusababisha maumivu, uharibifu au kifo.",
    "variations": ["ajali","ajali za kazini"],
    "emoji": "⚠️🚑"
  }
}
```
